...
data_element create variable  &
   variable_name = .MODEL_SEA20.q11  &
   adams_id = 1  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .MODEL_SEA20.q12  &
   adams_id = 2  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .MODEL_SEA20.q21  &
   adams_id = 3  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .MODEL_SEA20.q22  &
   adams_id = 4  &
   initial_condition = 0.0  &
   function = ""
!
...
!
marker create  &
   marker_name = .MODEL_SEA20.SEA_Spring_1.MARKER_24  &
   adams_id = 24  &
   location = 0.0, 2.5E-002, 0.255  &
   orientation = 3.1415508284, 1.5707904131, 0.0
!
...
variable modify  &
   ...
   object_value = (.MODEL_SEA20.motor1.MARKER_23)
!
variable modify  &
   variable_name = .MODEL_SEA20.Tk1.j_marker  &
   object_value = (.MODEL_SEA20.SEA_Spring_1.MARKER_24)
!
variable modify  &
...
variable modify  &
   ...
   real_value = (3.2436(newton-meter/deg))
!
variable modify  &
...
variable modify  &
   ...
   real_value = (1.274090354E-007(newton-meter-sec/deg))
!
variable modify  &
...
variable modify  &
   ...
   real_value = (3.0737(newton-meter/deg))
!
variable modify  &

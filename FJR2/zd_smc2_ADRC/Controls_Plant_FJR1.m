...
if flag == 0
  ...
  addpath( 'D:\Adams\controls/win32' ) ;
  addpath( 'D:\Adams\controls/matlab' ) ;
  addpath( 'D:\Adams\controls/utils' ) ;
  ADAMS_sysdir = 'D:\Adams\' ;
end
ADAMS_exec = '' ;
ADAMS_host = 'Ghost_Lee.lan' ;
ADAMS_cwd ='D:\04. Model\04. Adams'  ;
ADAMS_prefix = 'Controls_Plant_FJR1' ;
ADAMS_static = 'no' ;
ADAMS_solver_type = 'C++' ;
...
ADAMS_init = '' ;
ADAMS_inputs  = 'T1!T2' ;
ADAMS_outputs = 'Q1!q1_Q1!Q2!q2_Q2' ;
ADAMS_pinput = 'Controls_Plant_FJR1.ctrl_pinput' ;
ADAMS_poutput = 'Controls_Plant_FJR1.ctrl_poutput' ;
ADAMS_uy_ids  = [
                   5
                   6
                   1
